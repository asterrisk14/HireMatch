...
class _SkillFormDialogState extends State<SkillFormDialog> {
  ...
  String? _validateName(String? value) {
    ...
    if (trimmed.isEmpty) return 'Skill name is required.';
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (_isEditing) {
        await SkillsService.update(widget.skill!.id, name);
      } else {
        await SkillsService.create(name);
      }
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                DialogHeader(title: _isEditing ? 'Edit Skill' : 'New Skill'),
