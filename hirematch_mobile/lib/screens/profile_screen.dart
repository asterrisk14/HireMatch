...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _editProfile() async {
    ...
    final result = await Navigator.of(context).push<bool>(
      MaterialPageRoute(
        builder: (_) => EditProfileScreen(candidate: _candidate!),
      ),
    );
    if (result == true) {
      _load();
            ...
            : RefreshIndicator(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    Center(child: _buildAvatar(candidate)),
                    ...
                    _infoRow(
                      '📍',
                      'Location',
                      candidate?.locationDisplay.isNotEmpty == true
                    ...
                    _infoRow(
                      '📞',
                      'Phone',
                      candidate?.phone.isNotEmpty == true
                          ? candidate!.phone
                          : '—',
                    ),
                    ...
                    if (candidate?.preferredIndustryName.isNotEmpty == true)
                      _infoRow(
                        '🏷️',
                        'Preferred industry',
                        candidate!.preferredIndustryName,
                      ),
                    if (candidate?.preferredEmploymentTypeName.isNotEmpty ==
                      ...
                      _infoRow(
                        '💼',
                        'Preferred work type',
                        candidate!.preferredEmploymentTypeName,
                      ),
                    ...
                    if (candidate?.linkedInUrl.isNotEmpty == true ||
                        candidate?.portfolioUrl.isNotEmpty == true) ...[
                      const SizedBox(height: 18),
                      const Text(
                        '🔗 Links',
                        style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        ...
                        label: Text(
                          _isPremiumUser ? 'Premium active ⭐' : 'Go Premium ⭐',
                          style: const TextStyle(
                    ...
                    SizedBox(
                      width: double.infinity,
                      child: ElevatedButton.icon(
                        onPressed: candidate?.cvUrl.isNotEmpty == true
                            ? _openCV
                            : null,
                        style: ElevatedButton.styleFrom(
                        ...
                        label: Text(
                          candidate?.cvUrl.isNotEmpty == true
                              ? 'My CV'
                              : 'No CV uploaded yet',
